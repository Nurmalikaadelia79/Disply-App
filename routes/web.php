...
use App\Http\Controllers\Admin\BlogController as AdminBlogController;  // kasih alias
use App\Http\Controllers\Admin\EventController;
use App\Http\Controllers\Admin\CaseStudyController;
use App\Http\Controllers\BlogController as PublicBlogController;        // kasih alias
...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // Blog routes (pake AdminBlogController)
...
// Public Blog routes (pake PublicBlogController)
