...
@section('content')
    ...
    <div style="margin-bottom: 24px;">
        <a href="{{ route('admin.events.index') }}" style="color: var(--gray-600); text-decoration: none; display: inline-flex; align-items: center; gap: 8px; font-size: 14px;">
    ...
    <!-- Header -->
    <div style="margin-bottom: 24px;">
        <h1 style="font-size: 28px; font-weight: 700; color: var(--gray-800); letter-spacing: -0.5px;">Create New Event</h1>
        <p style="color: var(--gray-500); margin-top: 4px;">Fill in the form below to create a new event</p>
    </div>
    ...
    <div style="background: white; border-radius: var(--radius-lg); padding: 32px; box-shadow: var(--shadow);">
        <form action="#" method="POST" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 24px;">
                ...
                <textarea name="description" rows="8" placeholder="Write event description here..." 
            ...
            <div style="display: flex; gap: 12px; justify-content: flex-end; margin-top: 32px;">
                <a href="{{ route('admin.events.index') }}" style="padding: 12px 24px; background: white; border: 1px solid var(--gray-300); border-radius: var(--radius); color: var(--gray-700); text-decoration: none;">Cancel</a>
